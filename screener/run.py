...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = {
        ...
        "config": {
            ...
            "preferred_contractions": cfg.get_path("vcp.preferred_contractions"),
            "preferred_base_bars": cfg.get_path("vcp.preferred_base_bars"),
            "preferred_first_depth_pct": cfg.get_path("vcp.preferred_first_depth_pct"),
            "preferred_final_depth_pct": cfg.get_path("vcp.preferred_final_depth_pct"),
            "preferred_shrink_factor": cfg.get_path("vcp.preferred_shrink_factor"),
